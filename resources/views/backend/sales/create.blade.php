...
<tr>
<td scope="row"><?php print_r($element['id']); ?></td>
<td><?php print_r($element['product_id']); ?></td>
<td><?php print_r($element['quantity']); ?></td>
<td><?php print_r($element['price']*$element['quantity']); ?></td>

<td>
<input type="hidden" name="_method" value="DELETE">
        <input type="hidden" name="_token" value="MVog9uxBs05KE6m7sYoXaGPi5Qpm2dO09FyRcjVZ">
